...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/drupal_db?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/civicrm_db?new_link=true');
  }
}
...
$civicrm_root = '/Applications/XAMPP/xamppfiles/htdocs/drupal_756/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/XAMPP/xamppfiles/htdocs/drupal_756/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/drupal_756/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '0e77e610799fb963ad17aa558fe999db');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/XAMPP/xamppfiles/htdocs/drupal_756/sites/default/files/civicrm/templates_c//mail.log');
// }
